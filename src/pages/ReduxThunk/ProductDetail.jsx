...
import { getProductDetailActionThunk } from "../../redux/reducers/ProductPageReducer";
const ProductDetail = () => {
        ...
        <div className="col-12 col-lg-6">
          <div className="card shadow-sm border-0 rounded-4">
            <div className="card-body">
              <div
                className="bg-white border rounded-4 p-4 d-flex justify-content-center align-items-center"
                style={{ minHeight: 360 }}
              >
                {/* Main image */}
                <img
                  style={{ transform: rotate, maxHeight: 320 }}
              ...
              <div className="d-flex gap-2 mt-3 flex-wrap">
                {productDetail.detaildetailedImages?.map((item, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      className={`border ${className} rounded-3 p-2 bg-white`}
                      href="#"
                      aria-label="thumb 1"
                      onClick={(e) => {
                        setRotate(item);
              ...
              <a
                href="#"
                className="d-block text-decoration-none mt-3 text-secondary"
              >
            ...
            <div className="card-body">
              <div className="d-flex flex-wrap gap-2 mb-2">
                ...
                <span className="ms-auto text-secondary">
                  Thương hiệu: <b>Elmich</b>
                </span>
              </div>
              <h5 className="fw-bold mb-2">{productDetail.name}</h5>
              ...
              <div className="text text-dark">{productDetail.description}</div>
            </div>
          </div>
          {/* Shipping */}
          <div className="card shadow-sm border-0 rounded-4 mb-3">
              ...
              <div className="d-flex">
                ...
                <div className="flex-grow-1">
                  ...
                  <div className="text-secondary">
                    Trước 10h ngày mai:{" "}
                    <span className="fw-semibold text-dark">25.000đ</span>
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="ms-auto d-flex gap-2">
                  <span className="badge text-bg-light border text-primary">
                    Giảm 6%
                  </span>
                  <span className="badge text-bg-light border text-primary">
                    Giảm 5%
