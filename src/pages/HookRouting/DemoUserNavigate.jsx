...
const DemoUserNavigate = () => {
  //Qui tắt dùng hooks: Hook không bỏ trong if else hay function và luôn đặt trên đầu component
      ...
      <div className='w-50 mx-auto card my-5'>
        ...
        <div className='card-body'>
          ...
          <div className='form-group'>
            ...
            <input  type='password' className='form-control' id="password" name="password" value={userLoginForm.values.password} onInput={userLoginForm.handleChange} onBlur={userLoginForm.handleBlur} />
