...
export const httpClient = axios.create({
    ...
    timeout: 30000//sau 5 phút nếu không có phản hồi thì sẽ tự động hủy request
});

//Cấu hình cho tất request (là yêu cầu từ client gửi lên server)
...
//Cấu hình cho tất cả response (là phản hồi từ server trả về client)
